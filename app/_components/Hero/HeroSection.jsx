    ...
    <section className="bg-[#FDF6EC] flex flex-col justify-center items-center px-4 pt-20 pb-16">
      <div className="mx-auto max-w-1xl text-center">
        ...
        <p className="mt-6 sm:text-xl text-[#2D2D2D]">
          <span className="text-3xl font-bold text-[#2F855A]">+1 mil</span>{" "}
          pessoas já confiam no{" "}
          <span className="font-semibold">Dona Grana</span> para organizar suas
          finanças. E você?
        </p>
        ...
        <div className="flex justify-center mt-6">
          <div className="animate-bounce text-[#2F855A] text-3xl">&#8595;</div>
        </div>
      </div>
    </section>
  );
